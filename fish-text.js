...
const fishText = {
  ...
  'getRandomRangeCountries': (options) => {
    ...
    return checkTextDataType(dataType, yourCountries, 'getRandomRangeCountries');
  },
};
...
console.log(fishText.getRandomRangeCountries({min:10, max: 20, dataType: 'array', lang: 'rus'}));
